...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/venture/prebuilt/common/bootanimation))
...
PRODUCT_BOOTANIMATION := vendor/venture/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip
else
PRODUCT_BOOTANIMATION := vendor/venture/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip
endif
endif

ifdef VENTURE_NIGHTLY
PRODUCT_PROPERTY_OVERRIDES += \
    ro.rommanager.developerid=cyanogenmodnightly
else
PRODUCT_PROPERTY_OVERRIDES += \
    ro.rommanager.developerid=venturerom
endif
...
PRODUCT_COPY_FILES += \
    vendor/venture/CHANGELOG.mkdn:system/etc/CHANGELOG-VENTURE.txt
...
PRODUCT_COPY_FILES += \
    ...
    vendor/venture/prebuilt/common/bin/50-cm.sh:system/addon.d/50-cm.sh \
    vendor/venture/prebuilt/common/bin/blacklist:system/addon.d/blacklist
endif
...
PRODUCT_COPY_FILES +=  \
    vendor/venture/prebuilt/common/media/LMprec_508.emd:system/media/LMprec_508.emd \
    vendor/venture/prebuilt/common/media/PFFprec_600.emd:system/media/PFFprec_600.emd
...
# This is CM!
PRODUCT_COPY_FILES += \
    vendor/venture/config/permissions/com.cyanogenmod.android.xml:system/etc/permissions/com.cyanogenmod.android.xml

# T-Mobile theme engine
include vendor/venture/config/themes_common.mk
