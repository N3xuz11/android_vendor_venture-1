...
ALARM_PATH := vendor/venture/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/venture/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/venture/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/venture/prebuilt/common/media/audio/ui
